      ...
      <Layout style={{ minHeight: '100vh' }}>
        ...
        <Layout className="site-layout">
          ...
          <Content style={{ margin: '0 16px' }}>
            ...
            <div className="site-layout-background" style={{ textAlign: 'center', padding: 24, minHeight: 360 }}>
            
            <img src='./LogoAllFredo.png' alt='logo' width="100%"/>

            <Button style={{margin: "0 20px"}} type="primary" onClick={this.props.irParaCadastro}> 💰 Seja um All<i>Fredo</i> </Button>
                {console.log(this.props.irParaCadastro)}
            <Button type="primary" onClick={this.props.irParaCards}> 👁️‍🗨️ Contratar um All<i>Fredo</i> </Button>
